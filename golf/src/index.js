...
//
var timecomputaion = (14 * 1440 * 6 * 60 * 1000)
...
// read feed data from a file: 144 players
fFunc = () => {
...
// read feed data from a file: 288 players
mockFeed288 = () => {
    // let fileName = 'shortFeed.json'
    let fileName = 'feed288.json'
    // let fileName = 'aList.json'
...
courseFunc = () => {
    ...
    let fileName = 'LPGA-Drive-On-2020.json'
...
sortAndReturn10Fixed = () => {
    console.log("players LPGA top 10 sorted");
    return fetch(awsURL)
      .then(res => res.json())
      .then(res => {
        const playerData = res.GolfDataFeed.Tournament.Locatorboard.Player;
        const completeList = playerData
...
// LPGA tournamnet status feed
const lpgaTournaments = 'http://services.lpgascoring.com/ws/1.5/tournaments?clientId=70874eab-b701-47bb-be91-a42b2cb70da6'
...
const resolvers = {
    Query: {
        ...
        */
        ...
        tournamentStatus: () => {
            url = 'http://lpgaapplb-37320463.us-east-2.elb.amazonaws.com/api/tournaments'
        ...
        playersTop10Sorted: () => sortAndReturn10Fixed(),
        playersTop10SortedDemo: () => sortAndReturn10Demo(),
