...
// aList is a debug / testing array
var aList = []
var alistLength = 0

// tourData is for testing tournament status
var tourData =
...
aListFunc = () => {
    ...
    // console.log("length of a list =", aList.length)
}
...
courseFunc = () => {
    ...
    let fileName = 'September_coursefile-v3.json'
...
//
// Each is shown with a sample query
const resolvers = {
    Query: {
        /*
        query {
        ...
        */
        basicAnalytics: (parent, args) => {
            console.log(args)
            fanLogger.write(JSON.stringify(args) + '\n')
            return args
        },

        /*
            query { playersTop10Sorted {
                FirstName
                LastName
                Hole
                HoleLocation
